  ...
  <body>
    <div class="email-container">
      ...
      <div class="content">
        <!-- Intro Text -->
        <p class="intro-text">
          We received a request to verify your account on <strong>ServerPe</strong>. 
        ...
        <div class="security-warning">
          ...
          <ul>
            <li><strong>Never share</strong> this code with anyone, including ServerPe staff</li>
        ...
        <div class="help-section">
          ...
          <p style="margin: 8px 0;">
            ...
            <a href="https://www.serverpe.com/security/change-password">Change your password immediately</a> and 
            contact <a href="mailto:security@serverpe.com">security@serverpe.com</a>.
          </p>
        </div>
      ...
      <div class="footer">
        ...
        <div class="footer-company-info">
          ...
          <div class="footer-contact">
            ...
            <strong>Security:</strong> <a href="mailto:security@serverpe.com">security@serverpe.com</a><br>
        ...
        <div class="footer-links">
          ...
          <a href="https://www.serverpe.com/security">Security</a> |
          <a href="https://support.serverpe.com">Support</a> |
          <a href="https://www.serverpe.com/privacy">Privacy</a> |
          <a href="https://www.serverpe.com/terms">Terms</a>
        </div>
        ...
        <div class="autogenerated-notice">
          ...
          contact <a href="mailto:security@serverpe.com" style="color: #93c5fd;">security@serverpe.com</a> directly.
        </div>
