    ...
    <div class="email-container">
      ...
      <div class="content">
        ...
        <p style="text-align: center; margin-top: 30px;">
          <a href="https://www.serverpe.com/admin/visitors" style="
            display: inline-block;
            background: linear-gradient(135deg, #4f46e5 0%, #6366f1 100%);
            color: white;
            padding: 10px 24px;
      ...
      <div class="footer">
        ...
        <div class="footer-links">
          ...
          <a href="https://www.serverpe.com/admin">Admin Panel</a> |
        ...
        <div class="autogenerated-notice">
          ...
          contact <a href="mailto:support@serverpe.com" style="color: #93c5fd;">support@serverpe.com</a>.
        </div>
