const getSeatType2A = require("./getSeatType2A");
const getSeatStringA2 = (
  train_number,
  display_name_prefix,
  bogi_count,
  total_seat_count,
  ...
  try {
    for (let bogi = 0; bogi < bogi_count; bogi++) {
      ...
      //rac(2 pass sits in rac so 2 times)
      for (let seat = 0; seat < seat_rac; seat++) {
        seatStringForTrain =
          seatStringForTrain +
          "@" +
...
module.exports = getSeatStringA2;
