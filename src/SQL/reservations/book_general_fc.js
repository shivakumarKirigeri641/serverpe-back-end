  ...
  if (
    ...
    for (let i = 0; i < passengerdetails.rows.length; i++) {
      ...
      if (0 < result_seats_availability.rows[0].gen_count) {
        ...
        await client.query(
          `insert into seatallocation_fc (fkpassengerdata, fk_seatsondate_fc, seat_sequence_number, seat_status)values ($1,$2,$3,$4) returning *`,
          [
    ...
    throw {
      status: 200,
      success: false,
      message: "Seats are not available to book fc passengers.!",
    };
  }
...
module.exports = book_general_fc;
