...
const book_e3_rac = async (
  ...
  try {
    ...
    for (let i = 0; i < result_passengerdata.rows.length; i++) {
      let rac_count = result_seatsondate.rows[0].seat_count_e3_rac;
      //BOOK GENERAL TICKET IF AVAILABLE
      if (0 < result_seatsondate.rows[0].seat_count_e3_rac) {
