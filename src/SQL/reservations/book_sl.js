    ...
    switch (type_code) {
      ...
      case "GEN":
        ...
        //check if rac
          ...
          await client.query(
            `insert into seatallocation_sl (fkpassengerdata, fk_seatsondate_sl, seat_status, current_seat_status, updated_seat_status, seat_sequence_number)values ($1,$2,$3,$4,$5,$6) returning *`,
            [
              passengerdetails.rows[i].id,
              result_seats_availability.rows[0].id,
              "RAC",
